...
added5 <- data2 %>% filter((geo %in% c("DE411","DE412","DE413","DE414","DE415","DE416","DE417","DE418","DE421","DE422","DE423","DE424","DE425","DE426","DE427","DE428",
                                      "DE429","DE42A","DE805","DE806","DE807","DE809","DE80A","DE80D","DE80E","DE80G",
                                      "DE80H","DE915","DE919","DEA21","DEA25","DEB16","DEB19","DED11","DED12","DED13","DED14","DED15","DED16","DED17","DED18",
                                      ...
                                      "EL231","EL232","EL233","EL241","EL242","EL243","EL244","EL245","EL251","EL252","EL253","EL254","EL255",
                                      "FI131","FI132","FI133","FI134","FI181","FI182","FI183","FI184","FI185","FI186","FI187","FI1A1","FI1A2","FI1A3","FI1D4","FI1D6",
                                      "FR211","FR212","FR213","FR214","FR221","FR222","FR223","FR23","FR231","FR232","FR241","FR242",
                                      "FR243","FR244","FR245","FR246","FR251","FR252","FR253","FR261","FR262","FR263","FR264","FR301",
                                      "FR302","FR411","FR412","FR413","FR414","FR421","FR422","FR431","FR432","FR433","FR434",
                                      "FR511","FR512","FR513","FR514","FR515","FR522","FR523","FR524","FR531","FR532","FR533","FR534",
                                      "FR611","FR612","FR613","FR614","FR615","FR621","FR622","FR623","FR624","FR625","FR626","FR627","FR628",
                                      "FR631","FR632","FR633","FR711","FR712","FR713","FR714","FR715","FR716","FR717","FR718","FR721","FR722",
                                      "FR723","FR724","FR811","FR812","FR813","FR814","FR815","FR821","FR822","FR823","FR824","FR825","FR826",
                                      "FR831","FR832","FRA10","FRA20","FRA30","FRA40","FRA50","HR011","HR012","HR013",
                                      "HR014","HR015","HR016","HR021","HR022","HR023","HR024","HR025","HR026","HR027","HR028","HU101","HU102","IE011",
                                      "IE012","IE013","IE021","IE022","IE023","IE024","IE025","ITC45","ITD10","ITD20","ITD31","ITD32","ITD33","ITD34","ITD35",
                                      ...
                                      "ITE42","ITE43","ITE44","ITE45","ITF41","ITF42","LT001","LT002","LT003","LT004","LT005","LT006","LT007","LT008","LT009",
                                      "LT00A","NL121","NL122","NL123","NL322","NL326","NL331","NL334","NL335","NL336","NL338","NL339","PL113","PL114",
                                      "PL115","PL116","PL117","PL12","PL121","PL122","PL127","PL128","PL129","PL12A","PL12B","PL12C","PL12D","PL12E","PL215","PL216",
                                      "PL311","PL312","PL314","PL315","PL323","PL324","PL325","PL326","PL331","PL332","PL343",
                                      ...
                                      "UKI23","UKJ23","UKJ24","UKJ33","UKJ42","UKM21","UKM22","UKM23","UKM24","UKM25","UKM26","UKM27","UKM28","UKM31",
                                          ...
                                          ifelse(geo == "DE412", "DE405",
                                                 ifelse(geo == "DE413", "DE409",
                                                        ifelse(geo == "DE414", "DE40A",
                                                               ifelse(geo == "DE415", "DE40C", 
                                                                      ifelse(geo == "DE416", "DE40D",
                                                                             ifelse(geo == "DE417", "DE40F", 
                                                                                    ifelse(geo == "DE418", "DE40I", 
                                                                                           ifelse(geo == "DE421", "DE401",
                                                                                                  ifelse(geo == "DE422", "DE402",
                                                                                                         ifelse(geo == "DE423", "DE404", 
                                                                                                                ifelse(geo == "DE424", "DE406", 
                                                                                                                       ifelse(geo == "DE425", "DE407", 
                                                                                                                              ifelse(geo == "DE426", "DE408", 
                                                                                                                                     ifelse(geo == "DE427", "DE40B", 
                                    ifelse(geo == "DE428", "DE40E", 
                                           ifelse(geo == "DE429", "DE40G", 
                                                  ifelse(geo == "DE42A", "DE40H",
                                                         ifelse(geo == "DE805", "DE80L", 
                                                                ifelse(geo == "DE806", "DE80M", 
                                                                       ifelse(geo == "DE807", "DE80K",
                                                                              ifelse(geo == "DE809", "DE80K", 
                                                                                     ifelse(geo == "DE80A", "DE80O", 
                                                                                            ifelse(geo == "DE80D", "DE80L", 
                                                                                                   ifelse(geo == "DE80E", "DE80M",
                                                                                                          ifelse(geo == "DE80G", "DE80O", 
                                                                                                                 ifelse(geo == "DE80H", "DE80L", 
                                                                                                                        ifelse(geo == "DE915", "DE91C", 
                                                                                                                               ifelse(geo == "DE919", "DE91C", 
                                                                                                                                      ifelse(geo == "DEA21", "DEA2D", 
                                    ifelse(geo == "DEA25", "DEA2D", 
                                           ifelse(geo == "DEB16", "DEB1C", 
                                                  ifelse(geo == "DEB19", "DEB1D", 
                                                         ifelse(geo == "DED11", "DED41", 
                                                                ifelse(geo == "DED12", "DED44", 
                                                                       ifelse(geo == "DED13", "DED45", 
                                                                              ifelse(geo == "DED14", "DED42", 
                                                                                     ifelse(geo == "DED15", "DED45", 
                                                                                            ifelse(geo == "DED16", "DED43", 
                                                                                                   ifelse(geo == "DED17", "DED44", 
                                                                                                          ifelse(geo == "DED18", "DED42", 
                                                                                                                 ifelse(geo == "DED19", "DED43", 
                                                                                                                        ifelse(geo == "DED1A", "DED42", 
                                                                                                                               ifelse(geo == "DED1B", "DED42", 
                                                                                                                                      ifelse(geo == "DED1C", "DED45",
                                    ifelse(geo == "DED22", "DED2D", 
                                           ifelse(geo == "DED23", "DED2C", 
                                                  ifelse(geo == "DED24", "DED2C", 
                                                         ifelse(geo == "DED25", "DED2E", 
                                                                ifelse(geo == "DED26", "DED2D", 
                                                                       ifelse(geo == "DED27", "DED2E", 
                                                                              ifelse(geo == "DED28", "DED2D", 
                                                                                     ifelse(geo == "DED29", "DED2F", 
                                                                                            ifelse(geo == "DED2A", "DED2F",
                                                                                                   ifelse(geo == "DED2B", "DED2C", 
                                                                                                          ifelse(geo == "DED31", "DED51", 
                                                                                                                 ifelse(geo == "DED32", "DED53", 
                                                                                                                        ifelse(geo == "DED33", "DED43", 
                                                                                                                               ifelse(geo == "DED34", "DED52", 
                                                                                                                                      ifelse(geo == "DED35", "DED52", 
                                    ifelse(geo == "DED36", "DED53", 
                                           ifelse(geo == "EL111", "EL511", 
                                                  ifelse(geo == "EL112", "EL512", 
                                                         ifelse(geo == "EL113", "EL513", 
                                                                ifelse(geo == "EL114", "EL514", 
                                                                       ifelse(geo == "EL115", "EL515", 
                                                                              ifelse(geo == "EL121", "EL521", 
                                                                                     ifelse(geo == "EL122", "EL522", 
                                                                                            ifelse(geo == "EL123", "EL523", 
                                                                                                   ifelse(geo == "EL124", "EL524", 
                                                                                                          ifelse(geo == "EL125", "EL525", 
                                                                                                                 ifelse(geo == "EL126", "EL526", 
                                                                                                                        ifelse(geo == "EL127", "EL527",
                                                                                                                               ifelse(geo == "EL131", "EL531", 
                                                                                                                                      ifelse(geo == "EL132", "EL532", 
                                    ifelse(geo == "EL133", "EL531", 
                                           ifelse(geo == "EL134", "EL533", 
                                                  ifelse(geo == "EL141", "EL611", 
                                                         ifelse(geo == "EL142", "EL612",
                                                                ifelse(geo == "EL143", "EL613",
                                                                       ifelse(geo == "EL144", "EL611", 
                                                                              ifelse(geo == "EL211", "EL541", 
                                                                                     ifelse(geo == "EL212", "EL542", 
                                                                                            ifelse(geo == "EL213", "EL543", 
                                                                                                   ifelse(geo == "EL214", "EL541", 
                                                                                                          ifelse(geo == "EL221", "EL621", 
                                                                                                                 ifelse(geo == "EL222", "EL622", 
                                                                                                                        ifelse(geo == "EL223", "EL623", 
                                                                                                                               ifelse(geo == "EL224", "EL624", 
                                                                                                                                      ifelse(geo == "EL231", "EL631", 
                                    ifelse(geo == "EL232", "EL632", 
                                           ifelse(geo == "EL233", "EL633", 
                                                  ifelse(geo == "EL241", "EL641", 
                                                         ifelse(geo == "EL242", "EL42", 
                                                                ifelse(geo == "EL243", "EL643", 
                                                                       ifelse(geo == "EL244", "EL644", 
                                                                              ifelse(geo == "EL245", "EL645",
                                                                                     ifelse(geo == "EL251", "EL651", 
                                                                                            ifelse(geo == "EL252", "EL651", 
                                                                                                   ifelse(geo == "EL253", "EL652", 
                                                                                                          ifelse(geo == "EL254", "EL653", 
                                                                                                                 ifelse(geo == "EL255", "EL653", 
                                                                                                                        ifelse(geo == "FI131", "FI1D1", 
                                                                                                                               ifelse(geo == "FI132", "FI1D2", 
                                                                                                                                      ifelse(geo == "FI133", "FI1D3", 
                                    ifelse(geo == "FI134", "FI1D4", 
                                           ifelse(geo == "FI181", "FI1B1", 
                                                  ifelse(geo == "FI182", "FI1B1", 
                                                         ifelse(geo == "FI183", "FI1C1", 
                                                                ifelse(geo == "FI184", "FI1C2", 
                                                                       ifelse(geo == "FI185", "FI1C3",
                                                                              ifelse(geo == "FI186", "FI1C4",
                                                                                     ifelse(geo == "FI187", "FI1C5",  
                                                                                            ifelse(geo == "FI1A1", "FI1D5", 
                                                                                                   ifelse(geo == "FI1A2", "FI1D6", 
                                                                                                          ifelse(geo == "FI1A3", "FI1D7", 
                                                                                                                 ifelse(geo == "FI1D4", "FI1D8", 
                                                                                                                        ifelse(geo == "FI1D6", "FI1D9", 
                                                                                                                               ifelse(geo == "FR211", "FRF21", 
                                                                                                                                      ifelse(geo == "FR212", "FRF22", 
                                    ifelse(geo == "FR213", "FRF23", 
